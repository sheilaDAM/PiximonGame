...
public class InicioActivity extends AppCompatActivity {
    ...
    private void actualizarInterfaz(String nombreJugador, String imagenAvatar) {
        ...
        int resourceId = getResources().getIdentifier(imagenAvatar, "drawable", getPackageName());
        ivImagenJugador1.setImageResource(resourceId);
        tvNombreJugador1.setText(nombreJugador);
    ...
    private void cargarRecyclerContrincantes(List<Jugador> jugadoresAleatorios) {
        recViewContrincantes = findViewById(R.id.recViewAvatar);
